...
from app.models.teacher import AvailabilitySlot
from app.models.users import User
from app.models.teacher import Teacher
from app.services.timezone import to_utc, from_utc, is_valid_timezone
...
def get_teacher_availability(
    ...
    for slot in slots:
        ...
        from app.services.timezone import convert_teacher_slot_for_student
