  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <View style={s.header}>
        ...
        <TouchableOpacity style={s.videoBtn} onPress={() => router.back()}>
...
const s = StyleSheet.create({
  ...
  videoBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: C.primaryLight, alignItems: 'center', justifyContent: 'center' },
  scroll: { flex: 1 },
